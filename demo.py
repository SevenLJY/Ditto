...
from src.utils.metrics import eval_CD_ditto, axis_error, geodesic_distance, euclidean_distance, R_from_axis_angle
import torch
...
def save_axis_mesh(k, center, filepath):
    ...
    axis = o3d.geometry.TriangleMesh.create_arrow(cylinder_radius=0.002, cone_radius=0.004, cylinder_height=0.2, cone_height=0.008)
...
o3d.io.write_point_cloud('demo_start.ply', src_pcd)
o3d.io.write_point_cloud('demo_end.ply', dst_pcd)
